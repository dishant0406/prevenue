                ...
                <div className="flex flex-col items-center justify-center w-full z-10">
                    ...
                    <Container delay={0.1}>
                        <h2 className="text-balance !leading-[1.25] text-center text-4xl md:text-6xl font-semibold tracking-tight mt-6 w-full">
                            Prevenue Blog: <br className="hidden lg:inline-block" /> Insights & Best Practices
                        </h2>
                    </Container>

                    <Container delay={0.2}>
                        <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
                            Discover insights, tutorials, and best practices for maximizing revenue protection and no-show prevention with Prevenue
                        </p>
                    </Container>
                </div>
            </Wrapper>
